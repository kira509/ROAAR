...
const appname = process.env.APP_NAME || 'ROOAR BOT';
const herokuapi = process.env.HEROKU_API;
const gptdm = process.env.GPT_INBOX || 'TRUE';
const mode = process.env.MODE || 'PUBLIC';
const anticall = process.env.AUTOREJECT_CALL || 'TRUE';
const botname = process.env.BOTNAME || '𝗥𝗢𝗢𝗔𝗥-𝗕𝗢𝗧';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR || '𝗥𝗢𝗢𝗔𝗥';
const packname = process.env.STICKER_PACKNAME || '𝗚𝗘𝗡𝗘𝗦𝗜𝗦';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || '254738701209';
const owner = dev.split(",");
const menulink = process.env.MENU_LINK || 'https://github.com/kira509/ROAAR/blob/main/Media/Raven.jpg?raw=true';
